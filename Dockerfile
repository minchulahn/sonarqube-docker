...
RUN sed -i 's|#sonar.jdbc.username=sonar|sonar.jdbc.username=root|g' /opt/sonar/conf/sonar.properties
RUN sed -i 's|#sonar.jdbc.password=sonar|sonar.jdbc.password=root|g' /opt/sonar/conf/sonar.properties
